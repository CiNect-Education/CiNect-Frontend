...
export function useGiftCards(params?: QueryParams) {
  return useApiQuery<GiftCard[]>(["gift-cards", JSON.stringify(params)], "/gift-cards", params, {
    schema: z.array(giftCardSchema),
  });
}

export function useGiftCard(id: string) {
  return useApiQuery<GiftCard>(["gift-card", id], `/gift-cards/${id}`, undefined, {
...
export function useMyGiftCards(params?: QueryParams) {
  return useApiQuery<GiftCard[]>(["my-gift-cards", JSON.stringify(params)], "/me/gifts", params, {
    schema: z.array(giftCardSchema),
  });
}
...
export function usePurchaseGiftCard() {
  return useApiMutation<
    GiftCard,
    { giftCardId: string; recipientEmail?: string; message?: string }
