...
import {
  Clock, Calendar, Star, Play, Ticket, Users, Film, ThumbsUp,
  MessageSquare, MapPin, Send, ChevronLeft, ChevronRight,
} from "lucide-react";
...
export default function MovieDetailPage() {
  ...
  return (
    <div className="pb-12">
      ...
      {/* Hero Section */}
      <div className="relative h-[400px] overflow-hidden bg-gradient-to-b from-muted to-background lg:h-[500px]">
        {movie.bannerUrl ? (
          <>
            <Image
              src={movie.bannerUrl}
        ...
        <div className="absolute inset-0 flex items-end">
          <div className="mx-auto w-full max-w-7xl px-4 pb-8 lg:px-6">
            <div className="flex flex-col gap-6 lg:flex-row lg:items-end">
              {/* Poster */}
              <div className="relative aspect-[2/3] w-48 shrink-0 overflow-hidden rounded-lg border-4 border-background shadow-2xl lg:w-56">
                {movie.posterUrl ? (
                  <Image
                    src={movie.posterUrl}
                    alt={movie.title}
        ...
        <Tabs defaultValue="overview" className="space-y-6">
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground">
                    {movie.language}{movie.subtitles ? ` (Sub: ${movie.subtitles})` : ""}
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <TabsContent value="reviews" className="space-y-4">
            ...
            {isAuthenticated ? (
              ...
              <Card>
                <CardContent className="p-6 text-center">
                  <p className="mb-2 text-muted-foreground">Login to write a review</p>
                  <Button asChild>
            ...
            {reviewsLoading ? (
              ...
              <Card>
                <CardContent className="py-12 text-center">
                  <ThumbsUp className="mx-auto mb-3 h-12 w-12 text-muted-foreground" />
